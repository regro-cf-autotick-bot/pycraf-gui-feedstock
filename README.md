...
Once the `conda-forge` channel has been enabled, `pycraf-gui` can be installed with:

```
conda install pycraf-gui
```

It is possible to list all of the versions of `pycraf-gui` available on your platform with:
